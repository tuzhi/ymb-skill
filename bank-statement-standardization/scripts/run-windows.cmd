...
:entrypoint_missing
echo {"run_id":"","status":"ERROR","next_action":"REPORT_ERROR","reason_code":"PYTHON_ENTRYPOINT_REQUIRED","artifact_refs":[],"context_ref":"","message":"Python entrypoint script is required","contract_version":1}
exit /b 1

:runtime_missing
echo {"run_id":"","status":"ERROR","next_action":"REPORT_ERROR","reason_code":"PYTHON_RUNTIME_NOT_FOUND","artifact_refs":[],"context_ref":"","message":"Python runtime not found; set YMB_WORKBUDDY_PYTHON","contract_version":1}
exit /b 1
